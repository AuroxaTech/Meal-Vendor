...
import 'package:vendor/constants/app_ui_settings.dart';
...
import 'package:vendor/view_models/order_details.vm.dart';
import 'package:vendor/views/pages/order/widgets/order_actions.dart';
import 'package:vendor/views/pages/order/widgets/order_address.view.dart';
import 'package:vendor/views/pages/order/widgets/order_attachment.view.dart';
import 'package:vendor/views/pages/order/widgets/order_details_items.view.dart';
import 'package:vendor/views/pages/order/widgets/order_status.view.dart';
import 'package:vendor/widgets/base.page.dart';
import 'package:vendor/widgets/buttons/custom_button.dart';
import 'package:vendor/widgets/cards/order_summary.dart';
                      ...
                      child: orderSection(
                        VStack(
                          [
                            ...
                            //chat
                            Visibility(
                              visible: vm.order.canChatDriver && AppUISettings.canDriverChat,
                              child: CustomButton(
                    ...
                    orderSection(
                      VStack(
                        [
                          ...
                          //chat btn
                          Visibility(
                            visible: vm.order.canChatCustomer && AppUISettings.canCustomerChat,
                            child: CustomButton(
                              icon: FlutterIcons.chat_ent,
                              iconColor: Colors.white,
