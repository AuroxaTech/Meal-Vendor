...
class OrderPrinterSelector extends StatefulWidget {
  const OrderPrinterSelector(this.order, {super.key});
  final Order order;

  @override
  State<OrderPrinterSelector> createState() => _OrderPrinterSelectorState();
}
  ...
  void _tesPrint() async {
    ...
    bluetooth.isConnected.then((isConnected) {
      if (isConnected != null && isConnected) {
        ...
        bluetooth.printLeftRight(
          "Driver Tip".tr(),
          "  ${AppStrings.currencySymbol} ${widget.order.tip ?? '0.00'}"
              .currencyFormat(),
          1,
        );
        bluetooth.printNewLine();
