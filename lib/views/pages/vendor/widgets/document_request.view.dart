...
import 'package:vendor/view_models/document_request.vm.dart';
import 'package:vendor/views/pages/vendor/document_request.page.dart';
...
class DocumentRequestView extends StatelessWidget {
  const DocumentRequestView({super.key});
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<DocumentRequestViewModel>.reactive(
      ...
      builder: (
        ...
        //if model is busy
        if (model.isBusy) {
          return const BusyIndicator().centered().p(5);
        }
