...
import 'package:vendor/views/pages/profile/widgets/edit_payment_account.bottomsheet.dart';
import 'package:vendor/views/pages/profile/widgets/new_payment_account.bottomsheet.dart';
...
class PaymentAccountsViewModel extends MyBaseViewModel {
  ...
  Future<void> fetchPaymentAccounts([bool intialLoading = true]) async {
    if (intialLoading) {
