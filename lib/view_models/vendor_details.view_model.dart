...
import 'package:vendor/views/pages/shared/custom_webview.page.dart';
import 'package:vendor/widgets/bottomsheets/payout.bottomsheet.dart';
import 'package:vendor/widgets/bottomsheets/vendor_switcher.bottomsheet.dart';
...
class VendorDetailsViewModel extends MyBaseViewModel {
  ...
  initialise() async {
    ...
    fetchVendorDetails(refresh: false);
  }

  //
  Future<void> fetchVendorDetails({bool refresh = true}) async {
    if (!refresh) {
      setBusy(true);
    }
    try {
